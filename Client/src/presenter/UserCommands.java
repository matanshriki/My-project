...
//		commands.put("replay", new replayCommand());
		commands.put("selectMoves:", new selectMovesCommand());
		commands.put("SetDomain", new setDomain());
	...
	private class setDomain implements Command
	{
		@Override
		public Model doCommand(Model model, String args) {
			model.setDomainString(args);	
			return model;
		}		
	}
...
//	}
	...
	private class SolveDomainCommand implements Command
	{
		public Model doCommand(Model model, String args) {
			...
			model.UpdateChange("SolveDomain");
...
//	private class replayCommand implements Command
//	{
//		@Override
//		public Model doCommand(Model model, String args) {
//			model.UpdateChange("replay");			
//			return model;
//		}
//	}
	private class selectMovesCommand implements Command
	{
		...
		public Model doCommand(Model model, String args) {
			...
			model.setcurrentValues(args);//move up
			
		//	String ddd = model.splitandchecksmoves(moveto);
			model.UpdateChange(args);			
			return model;
		}
	}
}
